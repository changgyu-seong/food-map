...
- **Function Length & Modularity (P0):** Any function exceeding **60 lines** must be refactored into smaller, separate functions to maintain high readability and testability.
